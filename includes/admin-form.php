<?php
namespace legalpack\admin_form
{

    use legalpack\Legalpack;

    function checkbox($control_id, $label, $value)
    {
        Legalpack::template('form/checkbox', compact('control_id', 'label', 'value'));
    }

    function checkbox_group($control_id, $values)
    {
        Legalpack::template('form/checkbox-group', compact('control_id', 'values'));
    }

    function radio($control_id, $values)
    {
        Legalpack::template('form/radio', compact('control_id', 'label', 'values'));
    }
    ...
    abstract class Section
    {
        ...
        static function begin($section_id, $header)
        {
            ...
            Legalpack::template('form/section-begin', compact('section_id', 'header'));
        }
        ...
        static function end()
        {
            ...
            Legalpack::template('form/section-end', compact('section_id', 'header'));
...
namespace legalpack\admin_form\radio
{
    function yes_no()
    {
        return array(
